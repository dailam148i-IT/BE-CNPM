...
import { createOrderSchema, updateOrderStatusSchema, updatePaymentStatusSchema, queryOrdersSchema, cancelOrderSchema, } from './order.schema.js';
const router = Router();
// ============================================================================
 ...
 */
router.get('/', validateQuery(queryOrdersSchema), orderController.findAll);
/**
 * GET /api/orders/:id
 ...
 */
router.put('/:id/payment', authorize('ADMIN'), validate(updatePaymentStatusSchema), orderController.updatePaymentStatus);
