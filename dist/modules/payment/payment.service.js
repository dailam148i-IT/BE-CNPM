...
export const paymentService = {
    ...
    async generateQRCode(orderId) {
        ...
        const qrUrl = new URL(`https://img.vietqr.io/image/${BANK_CONFIG.BANK_BIN}-${BANK_CONFIG.ACCOUNT_NUMBER}-compact2.png`);
    ...
    async getSePayHistory(limit = 50) {
        try {
            ...
            const transactions = response.data.transactions?.map((trans) => ({
                id: trans.id,
