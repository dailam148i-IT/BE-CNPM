...
export const cartService = {
   ...
   */
  async getOrCreateCart(userId: string | null): Promise<CartWithTotal> {
    let cart;
   ...
   */
  async getCart(userId: string): Promise<CartWithTotal | null> {
   ...
   */
  async addItem(userId: string, data: AddToCartDto): Promise<CartWithTotal> {
   ...
   */
  async updateItem(userId: string, itemId: string, data: UpdateCartItemDto): Promise<CartWithTotal> {
    const { quantity } = data;
   ...
   */
  async syncCart(userId: string, data: SyncCartDto): Promise<CartWithTotal> {
    const { items } = data;
